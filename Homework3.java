...
public class Homework3 {
  ...
  public static void smoosh(int[] ints) {
	int startSearch = 0;
	int endSearch = ints.length - 1;
	
	for ( ; startSearch < endSearch; ) {		// Indice goes on only if indice != indice+1.
		
		if (ints[startSearch] == ints[startSearch+1]) {			// Move every int left, then set the last to -1.
