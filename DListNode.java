...
public class DListNode extends ListNode {
  ...
  public void insertAfter(Object item) throws InvalidNodeException {
    ...
    //   new node.
    if (this.next().isValidNode()) this.myList.insertBack(item);
    else {
    	DListNode newNode1 = ((DList)this.myList).newNode(item, (DList)this.myList, this, this.next);
        this.myList.size++;
        this.next.prev = newNode1;
        this.next = newNode1;
    }
  }
  ...
  public void insertBefore(Object item) throws InvalidNodeException {
    ...
    //   what DList it's in.  You should use myList.newNode() to create the
    //   new node.
    if (this.prev().isValidNode()) this.myList.insertFront(item);
    else {
    	DListNode newNode1 = ((DList)this.myList).newNode(item, (DList)this.myList, this.prev, this);
        this.myList.size++;
        this.prev.next = newNode1;
        this.prev = newNode1;
    }
  }
